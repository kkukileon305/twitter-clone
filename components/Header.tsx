...
const Header = () => {
  ...
  return (
    <header
      ...
      } duration-200 z-10 w-full h-[65px] bm:h-[53px] bm:w-4/5 bm:max-w-[600px] bm:border-r-[1px] left-0 bm:left-[20%] lm:left-[10%] xl:left-[26%] top-0 p-2 border-b-[1px] flex gap-2 backdrop-blur-md bg-white/70 border-slate-300`}
    >
